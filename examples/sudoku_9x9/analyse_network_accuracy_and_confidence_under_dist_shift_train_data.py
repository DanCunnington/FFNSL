...
from examples.sudoku_9x9.test_unstructured_data import perform_feature_extraction_for_problog
...
digits_test_csv = pd.read_csv('feature_extractor/data/digits_1_to_9/test/labels.csv')
...
if __name__ == '__main__':
    cmd_args = add_cmd_line_args(desc='Sudoku 9x9. Analyse neural network predictions and confidence scores'
                                      'on train sets',
