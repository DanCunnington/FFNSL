...
import re
import json
from examples.sudoku_9x9.analyse_incorrect_ILP_examples import is_valid
...
if __name__ == '__main__':
    cmd_args = add_cmd_line_args(desc='Sudoku 9x9 task. Analyse ILP example weight penalties',
