...
from examples.sudoku_4x4.ilp_config import background_knowledge, reduced_background_knowledge
...
def convert_examples_to_clingo_format(csv_file, net_type):
            ...
            for noise_idx, noise_pct in enumerate(noise_pcts):
                ...
                if d == non_perturbed_dataset and noise_pct > noise_pcts[0]:
                    ...
                    for train_idx in repeats:
                        ...
                        if net_type == 'reduced_background_knowledge':
                            complete_file = reduced_background_knowledge + '\n% Learned Hypothesis\n' + rules
                        else:
...
if __name__ == '__main__':
    cmd_args = add_cmd_line_args(desc='Sudoku 4x4 task. Run hypothesis testing', custom_args=custom_args)
