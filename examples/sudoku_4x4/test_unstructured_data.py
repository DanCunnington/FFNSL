...
from examples.sudoku_4x4.ilp_config import background_knowledge, reduced_background_knowledge_for_problog
from scipy import stats
from examples.sudoku_4x4.feature_extractor.dataset import load_data
from examples.sudoku_4x4.feature_extractor.network import MNISTNet
...
def convert_example_to_problog_format(row, preds, rules, net_type):
    if net_type == "reduced_background_knowledge":
        bk = reduced_background_knowledge_for_problog
    else:
...
if __name__ == '__main__':
    cmd_args = add_cmd_line_args(desc='Sudoku 4x4 task. Run inference evaluation.', custom_args=custom_args)
