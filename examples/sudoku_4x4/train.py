...
from ilp_config import background_knowledge, mode_declarations, reduced_background_knowledge, reduced_mode_declarations
...
def train(cmd_args):
    ...
    for net_type in networks:
        ...
        if 'constant' in net_type:
            ...
            net_preds = 'softmax'
        elif net_type == 'reduced_background_knowledge':
            net_preds = 'edl_gen'
        else:
            net_preds = net_type
            ...
            for noise_pct in noise_pcts:
                ...
                if d == non_perturbed_dataset and noise_pct > noise_pcts[0]:
                    ...
                    for train_idx, train_loader in enumerate(sud_train_loaders):
                        ...
                        # Adjust mode declarations and background knowledge for ablation
                        ...
                        if net_type == 'without_block':
                            ...
                            md = reduced_mode_declarations
                            bk = reduced_background_knowledge
                        else:
                        ...
                        if net_type == 'reduced_background_knowledge':
                            ilp_sys = FastLASSystem(executable='~/projects/PhD/FastLAS-reduced-bk-sudoku-4x4/FastLAS-public/FastLAS --solver=ASP')
                        else:
...
if __name__ == '__main__':
    cmd_args = add_cmd_line_args(desc='Sudoku 4x4 task. Run rule learning', custom_args=custom_args)
