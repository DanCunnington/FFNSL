...
network = PlayingCardNet()
dev = torch.device("cuda") if torch.cuda.is_available() else torch.device("cpu")
network.to(dev)
optimizer = optim.RMSprop(network.parameters(), lr=learning_rate, eps=epsilon, alpha=alpha, momentum=momentum)
...
# Print model summary
# summary(network, (3, 274, 174), batch_size=-1)
